...
class TransactionService extends GetxService {
  ...
  // Cancel a specific order using the updateOrderStatus endpoint
  Future<bool> cancelOrder(String orderId) async {
    try {
      debugPrint('\n=== TransactionService: Canceling Order ===');
      ...
      final message =
          response.data?['meta']?['message'] ?? 'Failed to cancel order';
      CustomSnackbarX.showError(
        title: 'Error',
        message: message,
        position: SnackPosition.BOTTOM,
